...
1. Run `npm run dev`
2. Navigate to each platform: `/projects/simcore`, `/projects/mezan`,
   `/projects/talai`, `/projects/optilibria`, `/projects/qmlab`
...
````typescript
/**
 * Brief description of the function/hook.
 *
...
- `src/projects/` - Platform configurations
